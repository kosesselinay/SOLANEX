...
class confirmOffer extends StatelessWidget {
  const confirmOffer({Key? key}) : super(key: key);
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(
                                "You have minted your asset as NFT. You can check your minted NFT on your profile.",
                                style: GoogleFonts.orbitron(
                                  color: Color.fromARGB(255, 160, 167, 164),
                                  fontSize: 15,
                                ),
